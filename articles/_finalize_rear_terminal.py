#!/usr/bin/env python3
"""4편(뒷면 2 + 충전단자 2)에 CTA + 관련글 + visible FAQ 추가."""
...
CTA_DATA = {
    "iphone-rear-broken-repair-cost": {
        "eyebrow": "REAR GLASS REPAIR COST",
        "h3": "공식 60~120만원 vs<br>다올 뒷면 단독 15~30만원",
        "p": "공식센터는 본체 통째 교체. 다올리페어는 뒷면만 단독 교체로 70~80% 절감.",
        "benefits": [("공식 대비 70%↓", "압도적 합리"), ("정품·호환 모두", "선택 가능"), ("1~2시간 작업", "당일 픽업"), ("90일 보증", "재발 시 무상")],
    },
    "iphone-rear-cracked-self-diagnosis": {
        "eyebrow": "REAR CRACKED DIAGNOSIS",
        "h3": "작은 균열도 1~2주 안에 수리<br>방치하면 비용 더 커집니다",
        "p": "균열 확장·습기 침투·다른 부품 영향. 작을 때 수리할수록 안전·저렴.",
        "benefits": [("자가진단 5단계", "매장 가기 전"), ("1~2주 안 권장", "방치 위험"), ("10~30만원", "작을 때"), ("90일 보증", "재발 시 무상")],
    },
    "iphone-charging-terminal-repair-cost": {
        "eyebrow": "CHARGING TERMINAL COST",
        "h3": "60%는 청소(1~2만원)로 끝<br>40%만 교체(8~14만원)",
        "p": "공식 25~35만원 대비 50~65% 절감. 라이트닝·USB-C 모두 가능.",
        "benefits": [("청소 1~2만원", "60% 케이스"), ("교체 8~14만원", "40% 케이스"), ("당일 30~50분", "교체 작업"), ("90일 보증", "재발 시 무상")],
    },
    "ipad-charging-terminal-repair-cost": {
        "eyebrow": "IPAD CHARGING TERMINAL",
        "h3": "프로·에어·미니·일반<br>모델별 충전단자 가격 공개",
        "p": "Thunderbolt 프로 20~22만원, 에어·미니·일반 13~17만원. 청소 1.5~2만원.",
...
RELATED_DATA = {
    "iphone-rear-broken-repair-cost": [
        ("iphone-rear-cracked-self-diagnosis.html", "iphone", "아이폰 뒷면이 깨졌어요 — 자가진단 5단계"),
        ("iphone-back-glass-cost-by-model-2026.html", "iphone", "후면유리 모델별 수리비 (2026)"),
    ...
    "iphone-rear-cracked-self-diagnosis": [
        ...
        ("iphone-back-glass-broken-danger.html", "iphone", "후면 깨짐 위험"),
        ("iphone-back-glass-genuine-vs-compatible.html", "iphone", "후면유리 정품 vs 호환"),
        ("iphone-back-glass-self-repair-risk.html", "iphone", "후면 자가수리 위험"),
    ],
    "iphone-charging-terminal-repair-cost": [
        ("iphone-charging-port-cleaning-vs-replacement.html", "iphone", "충전포트 청소 vs 교체 결정"),
        ("iphone-charging-port-cost-by-model-2026.html", "iphone", "충전포트 모델별 수리비"),
        ("iphone-charging-port-cleaning.html", "iphone", "충전포트 청소 가이드"),

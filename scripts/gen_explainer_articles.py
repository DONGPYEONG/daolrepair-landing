...
""",
            },
            {
                "h2": "공식센터로 가는 게 나을까?",
                "html": """
<p>메시지가 정말 거슬리시거나 공식 보증서가 꼭 필요하시면 공식센터를 추천드립니다. 다만 비교 포인트가 있어요:</p>
<table class="compare-table">
  <thead>
...
""",
        ...
        "faq": [
            ...
            ("정품 부품으로 교체했는데도 메시지가 뜨는 게 정상인가요?",
             "네, 정상입니다. 메시지는 부품 자체의 정품/비정품 여부가 아니라, 부품 시리얼이 본체와 정식으로 매핑됐는지를 보는 거예요. 매핑은 애플 공식센터에서만 갱신되기 때문에 사설에서 정품 부품을 쓰셔도 메시지가 뜹니다. 사용·터치·기능에는 전혀 영향이 없습니다."),
...
<p>매장에서 진단 후 \"수리 가성비 vs 새 폰 권장\" 솔직하게 안내드립니다. 무료 진단이라 가져오시는 게 가장 정확해요.</p>
""",
            },
        ],
